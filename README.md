...
### **Проект 2. Тестирование API веб-приложения для учителей от Skyeng**
...
### Проект 3. Тестирование API “Сервис Trello”
...
<br>
  ...
  ## 6. Проект автоматизация проверки входа существуещего пользователя в приложение “Sitechco”
...
**Проект**: Создание сайта с динамическим добавлением фильмов в новый раздел на JS
<br>
<a href="https://github.com/morozoffivan/jsmovies">
        Ссылка на репозиторий</a>
<br>
## Проект 10. “Сайт о правильном питание”

**Проект**: Создание сайта с динамической сменной картинок, формы обратной связи на JS
<br>
<a href="https://github.com/morozoffivan/jsmodal">
        Ссылка на репозиторий</a>
<br>
## Проект 11. “Про фехтование”

**Проект**: Создание нативного сайта
<br>
<a href="https://github.com/morozoffivan/fencer">
        Ссылка на репозиторий</a>
<br>

## Проект 12. “Калькулятор на Python”

**Проект**: Создание проекта "Калькулятор".

Инструкции к заданию:
<br>
Написать скрипт "калькулятор", который будет принимать от пользователя на вход:
<br>
1-е число
<br>
...
<br>
А так же предусмотреть проверку на то, что на ноль делить нельзя. И другие виды некорректно введенных данных.
<br>
<a href="https://github.com/morozoffivan/calc_project">
        Ссылка на репозиторий</a>
<br>
